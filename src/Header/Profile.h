...
#define IS_CHASE_FRAME          true
#define DEBUG                   false

#define PRESSURE_TEST           false

#define HEAD_SIZE               12

#define EPOLL_WAIT_TIME         22              // epoll_wait 阻塞时间
#define MAX_CLIENTS             3072            // epoll 最大连接数量

#define TMP_BUFFER_SIZE         1024            // 自定义临时缓冲区大小
#define MAX_BUFFER_SIZE         1048576          // 自定义最大缓冲区大小

#define DEFAULT_ROOM_COUNT      10000
#define ROOM_POOL_SIZE          10000

#define ONE_FRAME_MS            66              // 一帧的毫秒数
...
#define SERVER_FREE_COUNT       10               // 服务器空闲的人数上限
#define SERVER_COMMON_COUNT     100              // 服务器中等繁忙的人数上限
#define SERVER_BUSY_COUNT       5000            // 服务器繁忙的人数上限
